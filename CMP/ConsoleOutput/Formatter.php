...
class Formatter {
    ...
    * {@inheritdoc}
    */
   public function setStyle($name, FormatterStyle $style) {
    ...
    * @param string $string
    *
    * @return FormatterStyle|false false if string is not format string
    */
